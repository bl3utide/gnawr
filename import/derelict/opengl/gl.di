	...
	private 
	{
		...
		GLVersion findMaxAvailable()
		{
			...
			if (verstr.findStr("4.0") == 0)
				...
				if (verstr.findStr("3.3") == 0)
					return GLVersion.GL33;
				else
					if (verstr.findStr("3.2") == 0)
						return GLVersion.GL32;
					else
						if (verstr.findStr("3.1") == 0)
							return GLVersion.GL31;
						else
							if (verstr.findStr("3.0") == 0)
								return GLVersion.GL30;
							else
								if (verstr.findStr("2.1") == 0)
									return GLVersion.GL21;
								else
									if (verstr.findStr("2.0") == 0)
										return GLVersion.GL20;
									else
										if (verstr.findStr("1.5") == 0)
											return GLVersion.GL15;
										else
											if (verstr.findStr("1.4") == 0)
												return GLVersion.GL14;
											else
												if (verstr.findStr("1.3") == 0)
													return GLVersion.GL13;
												else
													if (verstr.findStr("1.2") == 0)
														return GLVersion.GL12;
													else
														if (verstr.findStr("1.1") == 0)
